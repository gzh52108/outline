...
class Lifecycle extends PureComponent{
    ...
    // shouldComponentUpdate一般用户组件性能优化
    ...
    //     // 业务逻辑：count的值为5的倍数时刷新组件，否则不刷新
    //     // console.log('count',nextState.count)
    ...
    render(){
        ...
        return (
            <div>
                ...
                {
                    goods.price ?
                    <p>价格：<del>{goods.price.old}</del><span>{goods.price.sales}</span></p>
                    :
                    null
                }
            </div>
